var HOSTserv = "https://loupop.ddns.net/pyt/"; // VULTR Ubuntu Server 16.04 docker Python 3.6.4
...
if (document.querySelector('meta[http-equiv="content-language"]'))
	...
	switch (langSet) {
	  case "fr":
		...
		langLbl["I0005"] = "&nbsp;ou le nom des ingr&eacute;dients de la recette ";
		langLbl["I0006"] = "&nbsp;le nom des ingr&eacute;dients de la recette ";
		langLbl["I0007"] = " nom de la recette";
	  ...
	  case "es":
		...
		langLbl["I0005"] = "&nbsp;o en el nombre de los ingredientes de la receta ";
		langLbl["I0006"] = "&nbsp;el nombre de los ingredientes de la receta ";
		langLbl["I0007"] = " nombre del recetas";
	  ...
	  default:
		...
		langLbl["I0005"] = "&nbsp;or the name of the recipe ingredients ";
		langLbl["I0006"] = "&nbsp;the name of the recipe ingredients ";
		langLbl["I0007"] = " name of the recipes";
